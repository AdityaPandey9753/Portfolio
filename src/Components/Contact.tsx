  ...
  return (
    <section id="contact" className="bg-chalk py-28 px-6">
      <div className="max-w-7xl mx-auto">
        <p className="font-mono text-xs text-ink/40 tracking-[0.2em] uppercase mb-3">
          06 · Contact
        </p>
          ...
          <div>
            {!sent ? (
              ...
              <div className="bg-lime rounded-3xl p-10 text-center">
                ...
                <p className="font-body font-semibold text-ink text-lg mb-2">
                  Message sent!
                </p>
            ...
            {[
              {
                icon: "@",
                label: "Email",
                val: "aditya.pandey9753@gmail.com",
                color: "bg-coral/10 text-coral",
              },
              {
                icon: "G",
                label: "GitHub",
                val: "github.com/adityapandey9753",
                color: "bg-ink/10 text-ink",
              },
              {
                icon: "in",
                label: "LinkedIn",
                val: "linkedin.com/in/adityapandey9753",
                color: "bg-sky/10 text-sky",
              },
              {
                icon: "📍",
                label: "Location",
                val: "Thane, Maharashtra, India",
                color: "bg-lime/10 text-lime",
              },
            ].map(({ icon, label, val, color }) => (
              <div
                key={label}
                className="bg-white rounded-2xl px-5 py-4 flex items-center gap-4 border border-ink/8 hover:border-ink/20 transition-colors"
              >
                <span
                  className={`w-10 h-10 rounded-xl flex items-center justify-center font-body text-sm font-medium flex-shrink-0 ${color}`}
                >
                  {icon}
                </span>
                <div>
